...
<body class="bg-light">
    <div class="container mt-3">
        <h1 class="text-center">Insert Bike</h1>
        <!-- form -->
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-outline md-4 w-50 m-auto p-2">
                <lebel for="product-image2" class="form-lebel"> Image2</lebel>
                <input type="file" name="product_image2" id="product_image2" class="form-control" required="required">
            </div>
            <div class="form-outline md-4 w-50 m-auto p-2">
                <lebel for="product-image3" class="form-lebel">Image3</lebel>
                <input type="file" name="product_image3" id="product_image3" class="form-control" required="required">
            </div>
            <div class="form-outline md-4 w-50 m-auto p-2">
                <lebel for="product-Price" class="form-lebel">Renting Price per days</lebel>
